...
public class Cookie {
    ...
    public Cookie(String domain, String name, String value,String rawValue, String path, int expires,int maxAge, boolean secure,boolean httpOnly) 
    {
    	cookie = new com.ning.http.client.cookie.Cookie(name, value, rawValue, domain, path, expires, maxAge, secure, httpOnly);
    	this.secure = secure;
    }
